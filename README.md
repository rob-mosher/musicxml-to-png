...
<div align="center">
  <img src="https://raw.githubusercontent.com/rob-mosher/musicxml-to-png/v0.6.1/docs/images/screenshot.png" alt="Example visualization showing MusicXML converted to PNG" width="100%" style="max-width: 1200px;">
</div>
...
See [Roadmap](https://raw.githubusercontent.com/rob-mosher/musicxml-to-png/v0.6.1/docs/roadmap.md) for planned features.
...
This project is licensed under the MIT License - see the [LICENSE](https://raw.githubusercontent.com/rob-mosher/musicxml-to-png/v0.6.1/LICENSE) file for details.
